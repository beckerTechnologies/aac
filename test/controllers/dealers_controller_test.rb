...
class DealersControllerTest < ActionController::TestCase
  ...
  test "should create dealer" do
    assert_difference('Dealer.count') do
      post :create, dealer: { address: @dealer.address, city: @dealer.city, license_number: @dealer.license_number, name: @dealer.name, state: @dealer.state, user_id: @dealer.user_id, zip: @dealer.zip }
    end
  ...
  test "should update dealer" do
    patch :update, id: @dealer, dealer: { address: @dealer.address, city: @dealer.city, license_number: @dealer.license_number, name: @dealer.name, state: @dealer.state, user_id: @dealer.user_id, zip: @dealer.zip }
    assert_redirected_to dealer_path(assigns(:dealer))
  end
